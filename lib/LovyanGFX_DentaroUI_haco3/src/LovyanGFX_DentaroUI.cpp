...
4078, 3917, 3770, 3530, 3300, 3050, 2970, 2670, 0
};
...
//    }
    ...
    //十字キーの出力値を揃える
    // if(directionBits==0){directionBits=7;}
    // else if(directionBits==2){directionBits=0;}
    // else if(directionBits==4){directionBits=2;}
    // else if(directionBits==7){directionBits=4;}
